...
function Runner_FMJDBC() {
  this.client = client;
  Runner.apply(this, arguments);
}
inherits(Runner_FMJDBC, Runner);

// Runs the query on the specified connection, providing the bindings
// and any other necessary prep work.
Runner_FMJDBC.prototype._query = Promise.method(function(obj) {
...
Runner_FMJDBC.prototype.processResponse = function(obj) {
