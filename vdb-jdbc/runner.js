...
function Runner_VDB_JDBC() {
  this.client = client;
  Runner.apply(this, arguments);
}
inherits(Runner_VDB_JDBC, Runner);

// Runs the query on the specified connection, providing the bindings
// and any other necessary prep work.
Runner_VDB_JDBC.prototype._query = Promise.method(function(obj) {
...
Runner_VDB_JDBC.prototype.processResponse = function(obj) {
